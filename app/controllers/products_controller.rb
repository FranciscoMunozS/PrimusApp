class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:ubication, :category, :item_code, :description, :unitary_cost, :total_value, :quantity, :user_id, :destination, :quantity_deploy, :required_user, :deploy_date, :provider_id)
    end
end
